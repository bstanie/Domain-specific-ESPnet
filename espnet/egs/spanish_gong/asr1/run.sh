...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    utils/combine_data.sh  data/${train_set}_org data/train_gong_unsupervised data/test_gong_unsupervised data/train_gong_first_pass data/train_gong_second_pass
    utils/combine_data.sh  data/${train_dev}_org data/test_gong_second_pass
    utils/combine_data.sh  data/${recog_set}_org data/test_gong_first_pass
